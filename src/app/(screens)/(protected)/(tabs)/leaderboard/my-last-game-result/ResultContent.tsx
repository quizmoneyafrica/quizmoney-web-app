...
import { EraserIcon, QMCoin, VerifiedBadge } from "@/app/icons/icons";
    ...
    >
      ...
      >
        ...
        <div>
          <motion.h1
            variants={itemVariants}
            className="capitalize text-lg md:text-2xl font-bold text-primary-900 flex items-center gap-1"
          >
            <span>
          ...
          {result.map((currentQuestion, index) => (
            ...
            >
              ...
              >
                ...
                {currentQuestion.usedEraser && (
                  <motion.div whileHover={{ scale: 1.1 }} className="pl-1">
                    <EraserIcon
