 ...
 * Protected layout
 *
 * Wraps all authenticated routes. Provides the app shell:
 * sidebar nav, header, content area.
 *
 * Removed:
 *   - <CheckSession /> — Axios interceptor handles token refresh automatically
 *   - <AppLiveQueries /> — STOMP/old WebSocket layer removed; Socket.io is
 *     used per-game-screen only
 *
 * <ProtectedRoute> handles the auth guard (redirect to /login if not authenticated).
 */
