  ...
  return (
    <div className="drop-shadow-sm rounded-[20px]">
      <div className="flex flex-col drop-shadow rounded-[20px] overflow-clip">
        ...
        <div className="relative z-[2] bg-primary-800 w-full px-4 py-5 rounded-b-[20px] flex items-center justify-between">
          <ShareBtn gamePrize={nextGameData?.gamePrize} startDate={nextGameData?.startDate} />
		  <PlayDemoBtn/>
		  {/* <JoinGameBtn/> */}
        </div>
      </div>
