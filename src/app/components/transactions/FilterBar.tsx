...
export function FilterBar(): React.ReactElement {
  return (
    <div className="mb-6 flex items-center gap-3 justify-between">
      <div className=" border flex-1  bg-white border-[#E4E3E3] rounded px-5 flex items-center">
      ...
      <button className="border border-[#E4E3E3] outline-none focus:ring-transparent cursor-pointer bg-white rounded px-4 py-2 text-sm flex items-center gap-2">
