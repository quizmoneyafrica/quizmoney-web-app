        ...
        <Dialog.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild>
              <motion.div
                className="fixed z-50 top-1/2 left-1/2 bg-white rounded-xl w-full max-w-[650px] overflow-hidden shadow-lg"
              ...
              >
                <div className="flex justify-between items-center p-6">
                  <Dialog.Title className="text-2xl font-bold text-[#303030]">
                    Transaction Details
                  </Dialog.Title>
                ...
                <motion.div
                  className="bg-blue-50 mx-6 mb-6 border border-dashed border-[#BCDDF4] rounded-xl p-6"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
